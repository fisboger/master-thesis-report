...
\\
\\
To detect CVE-2021-24086 we explored both \gls{ETW} and function hooking to gather relevant telemetry to discover a vulnerability in Windows. Unfortunately, we discovered that the detection opportunities, at least for CVE-2021-24086 and other vulnerabilities in \mintinline{c}{tcpip.sys}, are not great with \gls{ETW} as most telemetry herein is based on entering \emph{known} unintended states. With function hooking however, we get to define what is an unintended state and can therefore tailor our telemetry to our specific detection needs.
\\
\\
...

{
    ...
    \multirow{2}{*}{Cons} & \multicolumn{2}{l|}{\begin{tabular}[c]{@{}l@{}}Complex\\ Long development time\end{tabular}}                                                                                                                                              \\ \cline{2-3} 
